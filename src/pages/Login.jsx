    ...
    return (
        ...
        >
            ...
            <Grid item xs={12} align="center">
                <img src={PUBLIC_ICON} alt="SKY SOFT WARE" height="130px" width="175px" />
            </Grid>
            {/* form */}
            <Grid item>
                <Grid container
                ...
                >
                    <Grid item align="center">
                        <Typography style={{ fontFamily: "SourceSansPro", fontWeight: "700", color: Colors.secondaryText, fontSize: "22px" }}>
                            ĐĂNG NHẬP
                                </Typography>
                    </Grid>
                    <Grid item>
